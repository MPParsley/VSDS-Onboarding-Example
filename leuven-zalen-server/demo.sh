...
echo "  • LDES Server:         http://localhost:9003/zalen"
echo "  • LDES API/Swagger:    http://localhost:9003/admin/doc/v1/swagger-ui/index.html"
echo "  • Fuseki:              http://localhost:3032 (admin/admin)"
echo "  • RDF4J:               http://localhost:8082"
echo "  • LDIO Workbench:      http://localhost:9008"
echo "  • LDIO API/Swagger:    http://localhost:9008/swagger-ui/index.html"
echo ""
